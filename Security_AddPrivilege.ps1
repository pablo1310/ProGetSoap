...
$apiEndpoint = "http://localhost:8624/api/json/Users_GetGroups"
 ...
 $bodyFormFields = @{
   ...
   #Privilege_Id = ;
   #UserDirectory_Id = ";
   Principal_Name = 'ProGet-RegularCustomers@labo.local';
   #PrincipalType_Code = 
   # for "Role_Name":"View & Download Packages"
   Role_Id = 3;
   Feed_Id = 5; 
   #PrivilegeType_Code = 
}
...
<#
PS C:\Users\Administrator.LABO> C:\Users\Administrator.LABO\Documents\ProGet\Security_GetRoles.ps1
